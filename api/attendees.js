...
// Registrants who told us they can no longer attend — excluded from every count.
const NOT_COMING = new Set([
  "tfedwards85@gmail.com",
  "judygrodgers@gmail.com"
]);
const skip = e => isTest(e) || NOT_COMING.has((e||"").trim().toLowerCase());

// Static data not held in Eventbrite: Charlotte confirmations + Cary form families.
// Cary families who replied "Confirm" to a reminder email. Add their emails here
// (lowercase) as replies come in — they'll show as ✓ Confirmed on the dashboard.
const CARY_CONFIRMED_EMAILS = [
  "lisatsui412@gmail.com",       // Lisa
  "moniyi80@gmail.com",          // Monica Orellana
  "blackpanthergurl23@gmail.com",// Rob & Angel
  "carrinacevedo@gmail.com",     // Nicole Acevedo
  "sharimorgan1975@gmail.com",   // Shari Morgan
  "brooke_rouse@yahoo.com",      // Brooke Rouse
  "chartsf2@gmail.com",          // confirmed
  "cluvamk@yahoo.com",           // confirmed
  "nyarurig@gmail.com",          // Gladys Nyaruri
  "tibbsrobin@gmail.com",        // confirmed
  "jakiya.stackhouse@yahoo.com"  // Jakiya Stackhouse
];
...
const CHARLOTTE_ATTENDED_EMAILS = [
  ...
  "kadaijah93@icloud.com",    // Parrish Walker
  "sasi_apr_2@yahoo.co.in",   // Sashidhar Chellurl
  "ms.s.burns@gmail.com",     // Stephanie Burns
  "lovebrown47@gmail.com"     // Love Brown
];
const CONFIRMED_EMAILS = ["aissatou.naima29@gmail.com", "amandalopez0512@icloud.com", "asanthoshsagar@outlook.com", "bmsmall19@yahoo.com", "jasminebratton9023@gmail.com", "kionnadockery@yahoo.com", "kleenish26@yahoo.com", "ms.s.burns@gmail.com", "nturner1st@gmail.com", "shakethacrawford@yahoo.com", "slouther@gmail.com", "swathi.gujjari9@gmail.com", "thebestofthebest24@gmail.com", "tuliamolinagarcia@gmail.com"];
const CARY_FORM_FAMILIES = [{"source": "Microsoft Form", "order": "Form #6", "date": "2026-06-19", "purchaser": "Monica Orellana", "email": "Moniyi80@gmail.com", "phone": "6464201430", "timeslot": "11:00 AM-12:00 PM", "attendees": [{"child": "Mateo", "age": "10", "dx": "Yes", "aba": "No", "looking": "No", "gain": "Information", "haircut": "Yes"}, {"child": "Joseph", "age": "2", "dx": "Yes", "aba": "No", "looking": "I am exploring options", "gain": "Information", "haircut": "Yes"}], "confirmed": null, "count": 2}, {"source": "Microsoft Form", "order": "Form #7", "date": "2026-07-09", "purchaser": "Jolanda Dixon", "email": "jolandadixon26@gmail.com", "phone": "9843014726", "timeslot": "1:00 PM-2:00 PM", "attendees": [{"child": "Jaxyn Dixon", "age": "10", "dx": "Yes", "aba": "No", "looking": "No", "gain": "Mingling", "haircut": "No"}], "confirmed": null, "count": 1}, {"source": "Microsoft Form", "order": "Form #8", "date": "2026-07-11", "purchaser": "Aldabbagh", "email": "mustafasaad88@gmail.com", "phone": "9195239459", "timeslot": "11:00 AM-12:00 PM", "attendees": [{"child": "Taim Aldabbagh", "age": "11", "dx": "No", "aba": "No", "looking": "No", "gain": "Learning", "haircut": "Yes"}, {"child": "Jad Aldabbagh", "age": "4", "dx": "No", "aba": "No", "looking": "No", "gain": "Learning", "haircut": "Yes"}], "confirmed": null, "count": 2}, {"source": "Microsoft Form", "order": "Form #9", "date": "2026-07-14", "purchaser": "Vidhyabharathi Janarthanan", "email": "j.vidhyabharathi@gmail.com", "phone": "9379792092", "timeslot": "11:00 AM-12:00 PM", "attendees": [{"child": "Rudran", "age": "8", "dx": "Yes", "aba": "No", "looking": "No", "gain": "Just explore if anything would be suitable for the child", "haircut": "No"}], "confirmed": null, "count": 1}, {"source": "Microsoft Form", "order": "Form #10", "date": "2026-07-15", "purchaser": "Migdalis Clemmons", "email": "dmclemmons@hotmail.com", "phone": "9196568872", "timeslot": "1:00 PM-2:00 PM", "attendees": [{"child": "Ruby", "age": "6", "dx": "Yes", "aba": "No", "looking": "I am exploring options", "gain": "Different options", "haircut": "Yes"}], "confirmed": null, "count": 1}, {"source": "Microsoft Form", "order": "Form #11", "date": "2026-07-22", "purchaser": "Gladys Nyaruri", "email": "nyarurig@gmail.com", "phone": "9197417283", "timeslot": "12:00 PM-1:00 PM", "attendees": [{"child": "David Lode", "age": "10", "dx": "Yes", "aba": "Yes", "looking": "Yes", "gain": "Any resources that can help my child", "haircut": "Yes"}, {"child": "Gabriel Lode", "age": "12", "dx": "No", "aba": "No", "looking": "No", "gain": "Any resources that can help my child", "haircut": "Yes"}, {"child": "Ian Nyaruri", "age": "7", "dx": "No", "aba": "No", "looking": "No", "gain": "Any resources that can help my child", "haircut": "Yes"}], "confirmed": null, "count": 3}, {"source": "Microsoft Form", "order": "Form #12", "date": "2026-08-03", "purchaser": "Matthew Johns", "email": "radar4225@gmail.com", "phone": "9313601665", "timeslot": "12:00 PM-1:00 PM", "attendees": [{"child": "Noah Johns", "age": "7", "dx": "Yes", "aba": "Yes", "looking": "No", "gain": "Sense of community", "haircut": "Yes"}, {"child": "Sade' Johns", "age": "5", "dx": "Yes", "aba": "Previously received", "looking": "No", "gain": "Sense of community", "haircut": "No"}], "confirmed": null, "count": 2}, {"source": "Microsoft Form", "order": "Form #13", "date": "2026-08-04", "purchaser": "Riana Lik", "email": "Riananyc@hotmail.com", "phone": "917-783-3428", "timeslot": "11:00 AM-12:00 PM", "attendees": [{"child": "Lucas", "age": "", "dx": "", "aba": "", "looking": "", "gain": "Good time for children & haircuts", "haircut": "Yes"}, {"child": "Bianca", "age": "", "dx": "", "aba": "", "looking": "", "gain": "Good time for children & haircuts", "haircut": "Yes"}], "confirmed": null, "count": 2}];
...
export async function getEvents(token){
  ...
  const attended=new Set(CHARLOTTE_ATTENDED_EMAILS.map(e=>e.toLowerCase()));
  const charFams=buildFamilies(charRaw).map(f=>{
    const c=[...f.emails].some(e=>confirmed.has(e));
    const att=[...f.emails].some(e=>attended.has(e));
    delete f.emails;
    return {...f, confirmed:c, attended:att, count:f.attendees.length};
  });
  ...
  for(const ff of CHARLOTTE_FORM_FAMILIES){
    if(skip(ff.email)) continue;
    if(charEbEmails.has((ff.email||"").toLowerCase())) continue; // avoid double-count
    const emailL=(ff.email||"").toLowerCase();
    charFams.push({...ff, confirmed:confirmed.has(emailL), attended:attended.has(emailL), count:(ff.attendees||[]).length});
  }
  // Confirmed families: the static reply-"Confirm" list, plus any captured via
  // Vercel KV (if storage is ever connected). Either source marks them confirmed.
  const caryConfirmed=new Set([...CARY_CONFIRMED_EMAILS.map(e=>(e||"").trim().toLowerCase()), ...await getConfirmed("cary")]);
